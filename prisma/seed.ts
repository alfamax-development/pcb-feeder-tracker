...
async function seedFeederTypes() {
  const feederTypes = [
    { code: "SME8", displayName: "SME8", description: "SME 8mm electric feeder" },
    { code: "SM8", displayName: "SM8", description: "SM 8mm feeder" },
    { code: "SM12", displayName: "SM12", description: "SM 12mm feeder" },
    { code: "SM16", displayName: "SM16", description: "SM 16mm feeder" },
    { code: "SM24", displayName: "SM24", description: "SM 24mm feeder" },
  ];
